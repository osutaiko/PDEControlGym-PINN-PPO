...
dx, dy = 0.05, 0.05
X, Y = 1, 1
u_target = np.load('C:\\Users\\USER\Downloads\\PDEControlGym-main\\PDEControlGym-main\\examples\\NavierStokes\\target.npz')['u']
v_target = np.load('C:\\Users\\USER\Downloads\\PDEControlGym-main\\PDEControlGym-main\\examples\\NavierStokes\\target.npz')['v']
